...
public sealed class UiOperationCatalog : IUiOperationCatalog
{
    ...
    private static IReadOnlyList<UiOperationDescriptor> BuildOperations()
    {
        ...
        Op("clickheaderdropdownitem", "grid-table", "action", requiresSession: true, requiredInputs: ["locator"], aliases: [], deprecatedAliases: [],
        ...
        Op("clickmenu", "menu", "action", requiresSession: true, requiredInputs: ["value"], aliases: [], deprecatedAliases: []),
        ...
        Op("closewindow", "session-window", "action", requiresSession: false, requiredInputs: [], aliases: [], deprecatedAliases: []),
        ...
        Op("dragbyoffset", "mouse-keyboard", "action", requiresSession: false, requiredInputs: [], aliases: [], deprecatedAliases: [],
        ...
        Op("dragcoordinates", "mouse-keyboard", "action", requiresSession: false, requiredInputs: ["fromX", "fromY", "toX", "toY"], aliases: [], deprecatedAliases: []),
        ...
        Op("finduia", "native-uia", "diagnostic", requiresSession: false, requiredInputs: [], aliases: [], deprecatedAliases: [],
            requiredInputAlternatives: new string[][] { new[] { "locator" }, new[] { "nameContains" }, new[] { "bestMatch" }, new[] { "hwnd" }, new[] { "className" } }),
        ...
        Op("listtrackedwindows", "session-window", "query", requiresSession: false, requiredInputs: [], aliases: [], deprecatedAliases: []),
        ...
        Op("mouse", "mouse-keyboard", "action", requiresSession: false, requiredInputs: ["action"], aliases: [], deprecatedAliases: [],
            requiredInputAlternatives: new string[][] { new[] { "action", "x", "y" }, new[] { "action", "fromX", "fromY", "toX", "toY" } }),
        Op("mousescroll", "mouse-keyboard", "action", requiresSession: false, requiredInputs: [], aliases: ["wheelscroll"], deprecatedAliases: [],
            requiredInputAlternatives: new string[][] { new[] { "locator" }, new[] { "x", "y" } }),
        ...
        Op("scroll", "mouse-keyboard", "action", requiresSession: false, requiredInputs: [], aliases: [], deprecatedAliases: [],
        ...
        Op("selectcomboboxuia", "native-uia", "action", requiresSession: true, requiredInputs: ["locator"], aliases: [], deprecatedAliases: [],
            requiredInputAlternatives: new string[][] { new[] { "locator", "value" }, new[] { "locator", "index" } }),
        ...
        Op("selectheaderdropdownitem", "grid-table", "action", requiresSession: true, requiredInputs: ["locator"], aliases: [], deprecatedAliases: [],
            requiredInputAlternatives: new string[][] { new[] { "locator", "value" }, new[] { "locator", "index" } }),
        Op("selectopendropdownitem", "element-action", "action", requiresSession: true, requiredInputs: [], aliases: ["clickopendropdownitem"], deprecatedAliases: [],
            requiredInputAlternatives: new string[][] { new[] { "value" }, new[] { "index" } }),
